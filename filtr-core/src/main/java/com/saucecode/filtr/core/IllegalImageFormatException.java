...
public class IllegalImageFormatException extends Exception {

	/**
	 * 
	 */
	private static final long serialVersionUID = 185218460896188396L;
	 ...
	 * @since 1.4
	 */
	public IllegalImageFormatException(Throwable cause) {
		super(cause);
	}
	 ...
	 * @since 1.7
	 */
	protected IllegalImageFormatException(String message, Throwable cause, boolean enableSuppression,
